...
namespace ShopXpress.DAL.Migrations
{
    ...
    [Migration("20231127194206_addedAddress")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "bae6bc51-a327-4609-8778-9f2bc01203ee",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "a94b3162-0edc-44b5-a6a4-6ea9a149de7b",
                            Name = "Consumer",
            ...
            modelBuilder.Entity("ShopXpress.Models.Data.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2bfd9e4b-b895-4407-93e9-d06dd97091ae"),
                        ...
                        new
                        {
                            Id = new Guid("a8b4676f-0833-47c0-99eb-0f946d73beac"),
                        ...
                        new
                        {
                            Id = new Guid("dfe62f16-4303-4771-977c-c4170400d33f"),
                            CategoryId = new Guid("4678572e-5d7b-47c2-ab80-f8d6d8977017"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("00ee1325-9a06-42f2-807a-aa4da4b142f3"),
                        ...
                        new
                        {
                            Id = new Guid("711d8d31-4273-464c-8a3c-16c1aa10e949"),
                            CategoryId = new Guid("afb069bc-7ae9-4b5e-bf74-3350fe341894"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("38edc650-081f-4a0a-8061-c17501311f8f"),
                            CategoryId = new Guid("4678572e-5d7b-47c2-ab80-f8d6d8977017"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("5cda17d6-fca6-4c76-94a2-3856a4bbde97"),
                        ...
                        new
                        {
                            Id = new Guid("c18f6b94-57af-4426-b7a6-a24e5bf1f92f"),
                            CategoryId = new Guid("d06c834b-b93e-4eb9-9b70-253709130797"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("bead1a49-62a0-43d5-88e8-4e45ea7f283b"),
                            CategoryId = new Guid("4678572e-5d7b-47c2-ab80-f8d6d8977017"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("d09db29b-f1d3-4a14-93c8-f99db3411313"),
                        ...
                        new
                        {
                            Id = new Guid("255ac080-476e-41de-8c7d-72f269555cc7"),
                            CategoryId = new Guid("afb069bc-7ae9-4b5e-bf74-3350fe341894"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("7d951e6b-4bda-4cfc-87c9-5d85620b0895"),
                            CategoryId = new Guid("4678572e-5d7b-47c2-ab80-f8d6d8977017"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("6bff8586-0738-469d-87b7-02897961513d"),
                            CategoryId = new Guid("4678572e-5d7b-47c2-ab80-f8d6d8977017"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("c24b1e05-ac54-4985-b954-c1a89956bacb"),
                            CategoryId = new Guid("afb069bc-7ae9-4b5e-bf74-3350fe341894"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("f55ea150-9b79-4495-ab0f-cfe368f8ea6a"),
                            CategoryId = new Guid("d06c834b-b93e-4eb9-9b70-253709130797"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("6233a902-dff6-40cc-a2d9-29c35abb23ea"),
                        ...
                        new
                        {
                            Id = new Guid("ec2e6e25-bacf-4296-b7a4-3610687fb431"),
                            CategoryId = new Guid("4678572e-5d7b-47c2-ab80-f8d6d8977017"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("05982deb-e695-4fd2-8b6f-792ef1844524"),
                            CategoryId = new Guid("afb069bc-7ae9-4b5e-bf74-3350fe341894"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("0a9c2efc-e926-4f05-8e60-5c32e68256f0"),
                            CategoryId = new Guid("4ab2f398-3e1d-4cd0-8c21-55766bac483a"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("b6c626bd-c14b-4319-be91-9c319c599ac3"),
                            CategoryId = new Guid("d06c834b-b93e-4eb9-9b70-253709130797"),
                            CreatedAt = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
